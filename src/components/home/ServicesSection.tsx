...
const ServicesSection = () => {
  const services = [
    ...
    },
    {
      ...
      image:
        "https://storage.koompi.cloud/org_6969b022790a1dffd30229c1/isi-bds/images/design-build.jpg",
    },
  ];
        ...
        <div className="lg:grid lg:grid-cols-12 lg:gap-8 mb-20">
          ...
          >
            <p className="text-steel text-base leading-relaxed mt-6 lg:mt-0">
              Focusing on Developing Building Systems; Offering Design-Build
              Services Based on Prefabrication for safer and more sustainable
              construction.
            </p>
          </motion.div>
        </div>
