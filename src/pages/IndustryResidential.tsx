...
const IndustryResidential = () => {
  ...
  return (
    <div className="min-h-screen">
      <Helmet>
        <title>Residential Solutions | ISI Building Solutions</title>
        <meta
          name="description"
          content="Steel roofing and cladding solutions for residential projects — modern, durable, and cost-effective."
        />
      </Helmet>
            ...
            <div className="container mx-auto px-4 lg:px-8">
              ...
              >
                ...
                <p className="text-white/60 text-lg mt-6 max-w-2xl leading-relaxed">
                  Modern steel roofing and cladding solutions for residential
                  developments — durable, lightweight, and cost-effective.
                </p>
              </motion.div>
            </div>
          </div>
