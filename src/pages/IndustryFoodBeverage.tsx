...
const IndustryFoodBeverage = () => {
  ...
  const projects = [
    ...
    {
      image:
        "https://storage.koompi.cloud/org_6969b022790a1dffd30229c1/isi-bds/images/mee-chiet .jpg",
    },
    {
      image:
    ...
    <div className="min-h-screen">
      ...
      <section className="relative pt-[72px]">
        <div className="relative h-[40vh] min-h-[300px] overflow-hidden">
          <div className="absolute inset-0 bg-[url('https://storage.koompi.cloud/org_6969b022790a1dffd30229c1/isi-e-c/images/project-hanuman.jpg')] bg-cover bg-center"></div>
...
export default IndustryFoodBeverage;
