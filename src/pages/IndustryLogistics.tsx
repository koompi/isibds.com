...
const IndustryLogistics = () => {
  ...
  const projects = [
    {
      image:
        "https://storage.koompi.cloud/org_6969b022790a1dffd30229c1/isi-bds/images/logistic-warehouse.jpg",
    },
    {
      image:
        "https://storage.koompi.cloud/org_6969b022790a1dffd30229c1/isi-bds/images/logistic-2.jpg",
    },
    {
      image:
        "https://storage.koompi.cloud/org_6969b022790a1dffd30229c1/isi-bds/images/logistic-3.jpg",
    },
    {
      image:
        "https://storage.koompi.cloud/org_6969b022790a1dffd30229c1/isi-bds/images/logistic-4.jpg",
    },
  ];
    ...
    <div className="min-h-screen">
      ...
      <section className="relative pt-[72px]">
        <div className="relative h-[40vh] min-h-[300px] overflow-hidden">
          <div className="absolute inset-0 bg-[url('https://storage.koompi.cloud/org_6969b022790a1dffd30229c1/isi-bds/images/logistic-1.jpg')] bg-cover bg-center"></div>
...
export default IndustryLogistics;
